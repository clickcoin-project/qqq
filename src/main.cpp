...
uint256 hashGenesisBlock("0xc5b0c831dd4889658e0743b747a57d72209f589a77bdecd5942c90b804c5d343");
...
const string strMessageMagic = "LiteCoin Scrypt Signed Message:\n";
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 84000); // LitecoinScrypt block halving every 84000 blocks 
...
static const int64 nTargetTimespan = 60 * 60; // 1 hour retarget
static const int64 nTargetSpacing = 60; // 1 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal litecoin scrypt miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "LiteCoin Scrypt", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x78f6f2a77fbf3b8d56fb88a31b499568e1e71d545cd194e97dfac9b2dffa9499");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Litecoin Scrypt Released on April 1st 2014!";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1396403622;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 4292945;

        if (fTestNet)
        {
            block.nTime    = 1396349489;
            block.nNonce   = 290566;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x4c296421bd9dec7ac9ada6b2e1ceaf40e6077df0b0d6bef11c9793af2085b6fe"));
